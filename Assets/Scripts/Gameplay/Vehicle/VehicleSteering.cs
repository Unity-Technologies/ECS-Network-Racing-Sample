...
namespace Dots.Racing
{
    ...
    public partial struct SteeringJob : IJobEntity
    {
        ...
        private void Execute(in Steering steering, in WheelDriveControls wheelDriveControls, ref TransformAspect transformAspect, ref Wheel wheel)
        {
            float steeringAngle;
            ...
            transformAspect.LocalRotation = math.slerp(transformAspect.LocalRotation, targetRotation, steering.SteeringTime * DeltaTime);
        }
    }
